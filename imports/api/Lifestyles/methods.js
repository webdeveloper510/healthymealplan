...
Meteor.methods({
  "lifestyles.insert": function lifestylesInsert(lifestyle) {
    check(lifestyle, {
      ...
      discountBodybuilder: Match.Maybe(Number),
      extraBodybuilder: Match.Maybe(Number),
      discountOrExtraTypeBodybuilder: Match.Maybe(String),
  ...
  "lifestyles.update": function lifestylesUpdate(lifestyle) {
    ...
    if (
      !lifestyle.hasOwnProperty("extraAthletic") &&
      !lifestyle.hasOwnProperty("discountOrExtraTypeAthletic")
    ) {
    ...
    if (
      !lifestyle.hasOwnProperty("extraBodybuilder") &&
      !lifestyle.hasOwnProperty("discountOrExtraTypeBodybuilder")
    ) {
      keysToUnset.extraBodybuilder = "";
      keysToUnset.discountOrExtraTypeBodybuilder = "";
    }

    if (
      !lifestyle.hasOwnProperty("discountStudent") &&
      !lifestyle.hasOwnProperty("discountOrExtraTypeStudent")
    ) {
    ...
    if (
      !lifestyle.hasOwnProperty("discountSenior") &&
      !lifestyle.hasOwnProperty("discountOrExtraTypeSenior")
    ) {
