  ...
  render() {
    ...
    return (
      <form style={{ width: '100%' }} ref={form => (this.form = form)} onSubmit={event => event.preventDefault()}>
        ...
        <Grid container>
          <Grid item xs={12}>
            <Button onClick={() => this.props.history.push('/routes')} className="button button-secondary button-secondary--top">
              <Typography type="subheading" className="subheading font-medium" style={{ display: 'flex', alignItems: 'center', flexDirection: 'row', fontWeight: 'medium' }}>
                <ChevronLeft style={{ marginRight: '4px' }} /> Routes</Typography>
            </Button>
          </Grid>
        ...
        <Grid container style={{ marginBottom: '50px' }}>
          <Grid item xs={6}>
            <Typography type="headline" className="headline font-medium">Add route</Typography>
          </Grid>
