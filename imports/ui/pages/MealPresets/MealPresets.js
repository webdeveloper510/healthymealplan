...
import MealPresetsTable from './MealPresetsTable';

const ListContainer = Containers.ListContainer;

class MealPresets extends React.Component {
  constructor(props) {
    super(props);
          ...
          <Grid container className="clearfix">
            <Grid item xs={12} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <Button
                ...
                onClick={() => history.push('/meal-planner-presets/new')}
                raised color="primary" style={{ float: 'right' }}>
                Add preset
              </Button>
            </Grid>
          </Grid>
...
export default withTracker(() => {
  ...
  const subscription3 = Meteor.subscribe('mealpresets');
