              ...
              <TableHead>
                <TableRow>
                  ...
                  <TableCell
                    padding="none"
                    style={{ width: "20.33%" }}
                    onClick={() => this.props.sortByOptions("restrictionType")}
                  >
                    <Typography className="body2" type="body2">
                      Category
                    </Typography>
                ...
                return (
                  <TableRow hover className={e._id} key={e._id}>
                    ...
                    <TableCell
                      ...
                      style={{ width: "12%" }}
                      onClick={() =>
                        this.props.history.push(`/restrictions/${e._id}/edit`)
                      }
                    >
            ...
            <TableFooter>
              <TableRow>
                <TableCell>
                  ...
                  >
                    {this.props.count} of {this.props.categoryCount}{" "}
                    restrictions
                  </Typography>
                </TableCell>
                <TableCell />
        ...
        >
          ...
          <DialogContent>
            <DialogContentText className="subheading">
              ...
              {this.state.selectedCheckboxesNumber} restrictions?
            </DialogContentText>
          </DialogContent>
          <DialogActions>
            <Button
