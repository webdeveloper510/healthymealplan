...
class CustomersTable extends React.Component {
  ...
  renderNoResults(count) {
    if (count == 0) {
      return (
        <p style={{ padding: '25px' }} className="subheading">No customers found { this.props.searchTerm ? 
          `for &lsquo;<span className="font-medium">${this.props.searchTerm}</span>&rsquo;` : ''}</p>
      );
    }
  }
                ...
                this.props.results.map((e, i) => {
                  ...
                  return (
                    <TableRow hover className={e._id} key={e._id}>
                      ...
                      <TableCell padding="none" style={{ width: '8%' }} onClick={() => this.props.history.push(`/customers/${e._id}/edit`)}>
                        <Typography className="subheading" type="subheading">{e._id}</Typography>
                      </TableCell>
              ...
              <TableRow>
                <TableCell>
                  <Typography className="body2 font-medium" type="body2" style={{ color: 'rgba(0, 0, 0, .54)' }}>
                    {this.props.count} of {this.props.customerCount} customer{this.props.customerCount > 1 ? 's' : ''}
                  </Typography>
                </TableCell>
                <TableCell />
                {
