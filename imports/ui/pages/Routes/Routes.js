      ...
      <div>
        ...
        <Grid container className="SideContent SideContent--spacer-2x--horizontal SideContent--spacer-2x--top">
          ...
          <Grid container className="clearfix">
            <Grid item xs={6}>
              <Typography type="headline" gutterBottom className="headline pull-left" style={{ fontWeight: 500 }}>Routes</Typography>
            </Grid>
            <Grid item xs={6}>
              <Button className="btn btn-primary" onClick={() => history.push('/routes/new')} raised color="primary" style={{ float: 'right' }}>Add Route</Button>
            </Grid>
          </Grid>
