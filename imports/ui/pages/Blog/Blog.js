        ...
        <div>
          ...
          <Grid container className="SideContent SideContent--spacer-2x--top SideContent--spacer-2x--horizontal">
            <Grid container className="clearfix">
              <Grid item xs={6}>
                <Typography type="headline" gutterBottom className="pull-left headline" style={{ fontWeight: 500 }} color="inherit">Blog</Typography>
              </Grid>
              <Grid item xs={6}>
                <Button className="btn btn-primary" raised color="primary" style={{ float: 'right' }} onClick={() => this.props.history.push('/blog/new')}>Add article</Button>
              </Grid>
            </Grid>
...
export default withTracker(() => {
  const subscription = Meteor.subscribe('blog', {}, {});
